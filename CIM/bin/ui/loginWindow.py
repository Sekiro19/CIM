...
################################################################################
## Form generated from reading UI file 'loginSacqdk.ui'
##
...
"")
        ...
        self.btnConnect.setMinimumSize(QSize(110, 35))
        self.btnConnect.setMaximumSize(QSize(110, 35))
        self.btnConnect.setStyleSheet(u"")

        self.gridLayout.addWidget(self.btnConnect, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_51, 3, 0, 1, 2)
...
"")
        ...
        self.gridLayout.addWidget(self.btnClose, 0, 1, 1, 1, Qt.AlignRight)
        ...
        self.cBoxPost.setStyleSheet(u"QComboBox QAbstractItemView {\n"
"	color: rgb(90, 90, 90);\n"
...
"")
        ...
        self.gridLayout.addWidget(self.cBoxPost, 2, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.editPassword, 4, 0, 1, 2)
...
"}")
        ...
        self.gridLayout.addWidget(self.checkBoxShowPassword, 5, 0, 1, 2)
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.logo.setText("")
        self.label_7.setText(QCoreApplication.translate("LoginWindow", u"Compact Inventory Monitor", None))
        self.btnConnect.setText(QCoreApplication.translate("LoginWindow", u"connexion", None))
        self.label_51.setText(QCoreApplication.translate("LoginWindow", u"Mot de pass", None))
#if QT_CONFIG(tooltip)
        self.btnClose.setToolTip(QCoreApplication.translate("LoginWindow", u"Ferm\u00e9e", None))
#endif // QT_CONFIG(tooltip)
        self.btnClose.setText("")
        self.label_50.setText(QCoreApplication.translate("LoginWindow", u"Post de travail", None))
        self.cBoxPost.setItemText(0, QCoreApplication.translate("LoginWindow", u"Gestionnaire de stock", None))
        self.cBoxPost.setItemText(1, QCoreApplication.translate("LoginWindow", u"Superviseur de l'inventaire", None))
        self.cBoxPost.setItemText(2, QCoreApplication.translate("LoginWindow", u"Coordonnateur du service client\u00e8le", None))
        self.cBoxPost.setItemText(3, QCoreApplication.translate("LoginWindow", u"root", None))

        self.cBoxPost.setPlaceholderText("")
        self.checkBoxShowPassword.setText(QCoreApplication.translate("LoginWindow", u"Afficher le mot de passe", None))
    # retranslateUi
