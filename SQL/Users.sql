...
-- add passwords inplace of ***
CREATE LOGIN StockManager WITH PASSWORD = '***';
GO
CREATE LOGIN ServiceClient WITH PASSWORD = '***';
GO
CREATE LOGIN InventorySupervisor WITH PASSWORD = '***';
GO
CREATE LOGIN SU WITH PASSWORD = '***';
GO
